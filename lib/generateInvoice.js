...
const UNICODE_FONT_REG_URL = process.env.NEXT_PUBLIC_INVOICE_FONT_URL ||
    'https://fonts.gstatic.com/s/notosansarabic/v14/nwpStLi4_tnGQ8uLl-wVUHdptJ3j-FEV0q3ORkIa.0.woff2';
const UNICODE_FONT_BOLD_URL = process.env.NEXT_PUBLIC_INVOICE_FONT_BOLD_URL ||
    'https://fonts.gstatic.com/s/notosansarabic/v14/nwpStLi4_tnGQ8uLl-wVUHdptJ3jRFEV0q3ORkIa.0.woff2';
...
export const generateInvoice = async (order) => {
    ...
    // Bill To (left) - ensure all text uses unicode font for proper rendering
    ...
    doc.text(String(order?.address?.name || 'Customer'), margin.left, y + 8);
